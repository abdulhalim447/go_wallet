...
class BkashOneScreen extends StatefulWidget {
  const BkashOneScreen({Key? key}) : super(key: key);

  @override
  State<BkashOneScreen> createState() => _BkashOneScreenState();
}

class _BkashOneScreenState extends State<BkashOneScreen> {
                      ...
                      onPressed: () {
                        if (_searchController.text.isNotEmpty) {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => BkashTwoScreen(
