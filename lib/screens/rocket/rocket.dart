...
import 'package:go_wallet/screens/rocket/rocket_two.dart';
import 'package:go_wallet/screens/upay/upay_two.dart';
import 'package:permission_handler/permission_handler.dart';

class RocketOneScreen extends StatefulWidget {
  const RocketOneScreen({Key? key}) : super(key: key);

  @override
  State<RocketOneScreen> createState() => _RocketOneScreenState();
}

class _RocketOneScreenState extends State<RocketOneScreen> {
                      ...
                      onPressed: () {
                        if (_searchController.text.isNotEmpty) {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => RocketTwoScreen(
