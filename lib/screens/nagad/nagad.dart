...
class NagadOneScreen extends StatefulWidget {
  const NagadOneScreen({Key? key}) : super(key: key);

  @override
  State<NagadOneScreen> createState() => _NagadOneScreenState();
}

class _NagadOneScreenState extends State<NagadOneScreen> {
                      ...
                      onPressed: () {
                        if (_searchController.text.isNotEmpty) {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => NagadTwoScreen(
